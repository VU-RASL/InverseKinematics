...
namespace BioIK {
    ...
    public partial class BFGS {
        ...
        public void Minimise(double[] values, ref bool evolving) {
            ...
            var nullspace = jacobian.Multiply(jacobian.PseudoInverse());
        ...
        public void Minimise(double[] values, double timeout) {
            ...
            var nullspace = jacobian.Multiply(jacobian.PseudoInverse());
            var subtraction = identity.Subtract(nullspace);
            Debug.Log(subtraction * 0.25);
            // Solution += step * nullspace * gradient;
            // need to multiply this gradient by the solution... 
            // gradient + nullspace 
            // Debug.Log(newGradient);
