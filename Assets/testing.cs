...
public class testing : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log("Here's the identity:");
        Debug.Log(M.DenseIdentity(4));

        Debug.Log("Sin of 90:");
        Debug.Log(Math.Sin(90));

        Debug.Log("Testing the Jacobian...");
        ComputeJacobian(0.0,2.0,0.0,1.0,0.0,1.0,2.0);
    }
    ...
    private void ComputeJacobian(double theta1, double theta2, double theta3, double theta4, double theta5, double theta6, double theta7)
    {   
